      ...
      <Container >
        ...
        <Row>
          ...
          <ul className='About-ul'>
            ...
            <li className='About-li'>FOOD</li>
            <li className='About-li'>Video production & editing</li>
            <li className='About-li'>Indie games</li>
          </ul>

          <p>Check out my <a href="https://www.linkedin.com/in/sniebauer/" target="new">LinkedIn</a> for more. Thanks!</p>
