    ...
    return (
      <div className='footer-div'>
        ...
        <ul className='social-list'>
          <li className='icon-list'><a href='https://twitter.com/steveniebauer' target='_new'><i className="fa fa-twitter-square" aria-hidden="true"></i></a></li>
          ...
          <li className='icon-list'><a href='http://github.com/sniebauer' target='_new'><i className="fa fa-github-square" aria-hidden="true"></i></a></li>
        </ul>
